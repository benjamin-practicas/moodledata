...
$string['messageprovider:infected'] = 'Notificaciones de fallas de antivirus.';
...
$string['privacy:metadata:oauth2_refresh_token:issuerid'] = 'El ID del emisor al que corresponde el token';
